...
//
//import com.tagtheagency.portal.security.oauth2.google.GoogleUserInfoTokenServices;
//
///**
// * <p>
...
//	 */
////	@Bean
////	@Description("Filter that checks for authorization code, and if there's none, acquires it from authorization server")
////	public OAuth2ClientAuthenticationProcessingFilter oauth2ClientAuthenticationProcessingFilter() {
////		// Used to obtain access token from authorization server (AS)
////		
////		System.out.println("oauth auth processing filter");
////		
////		OAuth2RestOperations restTemplate = new OAuth2RestTemplate(authorizationCodeResource(), oauth2ClientContext);
////		OAuth2ClientAuthenticationProcessingFilter filter = new GoogleAuthenticationProcessingFilter(oauth2FilterCallbackPath);
...
//		GoogleUserInfoTokenServices userInfoTokenServices = new GoogleUserInfoTokenServices(userInfoUri, clientId, oauth2ClientContext);
