...
public class JwtAuthenticationTokenFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public JwtAuthenticationTokenFilter() {
        super("/pitch/**");
        System.out.println("Constructing the auth token filter");
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) {
    	System.out.println("JWT attempting authentication");
    	String header = request.getHeader(this.tokenHeader);

        final String HEADER_START = "Bearer ";
        
        if (header == null || !header.startsWith(HEADER_START)) {
        	System.out.println("Sending missing token exception");
        ...
        try {
        	...
        	System.out.println("Expired or malformed jwt");
        	e.printStackTrace();
